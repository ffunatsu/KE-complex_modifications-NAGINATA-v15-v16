...
> [!Note]
> 水島さんの[改良版](https://kazuki-mizuc.com/naginata-v15fix-r604-for-karabiner/)があり、作者の許可を得てマージ済みです。（Naginata_v15-R604.json を Naginata_v15.json に上書きマージしています。タイピングゲーム用にはマージできていませんのであしからず。）
